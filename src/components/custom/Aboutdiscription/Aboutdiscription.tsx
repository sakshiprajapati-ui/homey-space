...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-dvh bg-linear-to-b from-white to-slate-50 text-slate-800">
      <section className="mx-auto max-w-6xl px-4 py-20 mt-10 sm:py-24">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <Button className="bg-linear-to-r from-blue-600 to-sky-500 text-white shadow-md hover:opacity-90">
              Explore Listings
            </Button>
          </motion.div>
