...
function ShimmerBG() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-sky-900 via-indigo-900 to-cyan-800" />
    ...
    <div className="relative min-h-screen px-6 py-16 text-white">
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-4xl font-bold mb-4 bg-linear-to-r from-cyan-300 to-indigo-400 bg-clip-text text-transparent drop-shadow-lg"
        >
            ...
            >
              <Card className="rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 shadow-lg hover:border-cyan-400 hover:shadow-cyan-500/20 transition">
                <CardContent className="flex flex-col items-center p-6 space-y-4">
                  {cat.icon}
                  <h3 className="text-xl font-semibold bg-linear-to-r from-cyan-300 to-indigo-400 bg-clip-text text-transparent">
                    {cat.type}
                  </h3>
