...
function Shimmer({ children }: { children: React.ReactNode }) {
  return (
    <span className="relative inline-flex overflow-hidden rounded-2xl">
      <span className="absolute inset-0 -translate-x-full animate-[shimmer_2s_infinite] bg-linear-to-r from-transparent via-white/30 to-transparent" />
      <style jsx>{`
        @keyframes shimmer {
...
function SpotlightBG() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      <div className="absolute left-1/2 top-[-20%] h-[60vh] w-[60vh] -translate-x-1/2 rounded-full bg-linear-to-br from-blue-400/20 to-cyan-400/10 blur-3xl" />
      <div className="absolute right-[10%] bottom-[-10%] h-[40vh] w-[40vh] rounded-full bg-linear-to-br from-indigo-400/20 to-blue-400/10 blur-3xl" />
...
export default function SafetySecuritySection({ variant = "default" }: { variant?: "pg" | "hostel" | "apartment" | "default" }) {
  ...
  return (
    <section className="relative mx-auto max-w-7xl scroll-mt-24 rounded-3xl border border-blue-500/10 bg-linear-to-b from-white to-blue-50/40 p-6 shadow-sm md:p-10">
      <SpotlightBG />
      ...
      <div className="mb-8 flex flex-col items-start gap-3 md:mb-12 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h2 className="text-2xl font-semibold tracking-tight md:text-4xl text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-cyan-400">
        ...
        <div className="flex gap-2">
          <Shimmer>
            <Button asChild className="rounded-2xl bg-linear-to-r from-blue-500 to-cyan-400 text-white">
      ...
      {/* CTA */}
      <div className="mt-8 flex flex-col items-center justify-between gap-4 rounded-2xl border bg-linear-to-r from-blue-600 to-cyan-500 p-6 text-white md:flex-row">
        <div>
